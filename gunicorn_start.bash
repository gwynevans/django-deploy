...
DJANGODIR=/webapps/myapp_django/myapp             # Django project directory
SOCKFILE=/webapps/myapp_django/run/gunicorn.sock  # we will communicte using this unix socket
